    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div
            key={card.label}
            className={`glass rounded-xl p-3 md:p-4 border ${card.border}`}
          >
            <p className="text-[10px] md:text-xs text-muted-foreground font-medium uppercase tracking-wider mb-1">
              {card.label}
            </p>
            <p
              className={`text-base md:text-xl font-bold ${card.color} tabular truncate`}
            >
        ...
        <div className="flex items-center gap-2">
          ...
          {hasActiveFilters && (
            <Button
              ...
              className="shrink-0 h-9 text-muted-foreground gap-1"
            >
          ...
          <div className="divide-y divide-border">
            ...
            {filtered.map((t) => (
              ...
              >
                ...
                {/* Amount */}
                <p
                  className={`text-sm font-bold shrink-0 tabular ${t.type === "INCOME" ? "text-accent" : "text-destructive"}`}
                >
                  {t.type === "INCOME" ? "+" : "−"}
