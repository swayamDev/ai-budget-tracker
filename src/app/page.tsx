    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative pt-36 pb-24 px-5 text-center">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {/* Headline */}
          <h1
            className="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.08] mb-6 animate-fade-in"
        ...
        <div
          className="relative mt-20 max-w-5xl mx-auto animate-fade-in"
            ...
            <div className="bg-card rounded-xl overflow-hidden">
              ...
              <div className="p-5 grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  >
                    ...
                    <p className={`text-lg font-bold ${stat.color} tabular`}>
                      {stat.value}
                    </p>
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded-full font-semibold ${stat.tagColor}`}
                    >
                      {stat.tag}
                    </span>
                  </div>
              ...
              <div className="px-5 pb-5 grid grid-cols-3 gap-3">
                <div className="col-span-2 glass rounded-xl p-4 h-28 flex items-end gap-1">
                  {[35, 60, 42, 78, 52, 88, 67, 82, 58, 92, 72, 85].map(
                    (h, i) => (
                      <div
                        key={i}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              >
                <div
                  className={`w-11 h-11 rounded-xl ${feature.bg} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-200`}
                >
